...
def main():
    ...
    txt_path1 = os.path.join(BASE, 'data', 'labels', 'train_filtrado_phikon.txt')
    ...
    train_loader = torch.utils.data.DataLoader(train_dataset,
                                               ...
                                               num_workers=nw)
    txt_path2 = os.path.join(BASE, 'data', 'labels', 'val_filtrado_phikon.txt')
    ...
    with open(os.path.join(BASE, 'reporting', 'dual_inceptionv3', 'result_phikon.txt'), "w") as f:
        best_rmse = float('inf')
        lr_list = []
        for epoch in range(epochs):
            ...
            if val1_rmse < best_rmse:
                best_rmse = val1_rmse
                torch.save(net.state_dict(), os.path.join(BASE, 'checkpoints', 'dual_inceptionv3', 'dual_inceptionv3_phikon_best.pth'))
            ...
            f.write("\n ")
        torch.save(net.state_dict(), os.path.join(BASE, 'checkpoints', 'dual_inceptionv3', 'dual_inceptionv3_phikon.pth'))
